...
public class Geekder_interfaz extends JFrame {
	...
	public Geekder_interfaz() {
		...
		JTabbedPane tabbed_pstañas = new JTabbedPane(JTabbedPane.TOP);
		tabbed_pstañas.setBounds(0, 0, 842, 451);
		contentPane.add(tabbed_pstañas);
		
		JPanel Panel_Match = new JPanel();
		tabbed_pstañas.addTab("Match", null, Panel_Match, null);
		...
		tabbed_pstañas.addTab("Chats", null, Panel_Chats, null);
		...
		tabbed_pstañas.addTab("New tab", null, Panel_Publicaciones, null);
